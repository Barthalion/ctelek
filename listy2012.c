//program p9, KTB Nov 25,1996, KTZ 2013
...
typedef rE tE[kmax];    // E - do generacji grafu
...
// void sortlista2(ref **h); // sortowanie z zamiana wskaznikow
//------------------------------------------------------------------------------
...
printf("Wariant: (1/2/3/4/5/6)");
  ...
  switch(wariant)
  {
        ...
        case 6://czas Gnf
      {
        ...
        /*
          case 7:// zapis grafow w postaci kanonicznej na liste
            {
...
int m;
    ...
    printf("m= ");
    for(m=0;m<=f;m++) printf("%7d",m);
    printf("\n");
    for(m=0;m<=f+1;m++) printf("-------");
    printf("\n");
    printf("Q= ");
    for(m=0;m<=f;m++) printf("%7d",Q[m]);
    printf("\n");
}//drukQ
