//program p7, KTB Nov 12,1996, KTZ 2013
...
t1 E;
TGraph G1, G2;
nazwa_pliku devW; FILE *W;    //  wszystkie wygenerowane sc-grafy
nazwa_pliku devZ; FILE *Z;    //  przesiane sc-grafy
clock_t czas1, czas2;
      ...
      switch(wariant)
  {
        case 1: //czy G1 = Gnk i G2 = dopelnienie G1 sa izomorficzne?
        {
            ...
            case 2:// konstr pliku W zawierajacego sc-grafy
            {
              ...
              scanf_s("%s",devW,15);
              fopen_s(&W,devW,"wt");      //przygotowanie pliku W do zapisu
              czyt(&n, &k, &rep);
      ...
      case 3://konstr pliku W i przesiewanie do pliku Z
            {
              printf("nazwa pliku W:");
              scanf_s("%s",devW,15);
              fopen_s(&W,devW,"wb");      //przygotowanie pliku W do zapisu
              czyt(&n, &k, &rep);
              konstr(n, k, rep, W, &g); // plik W o dlugosci g
