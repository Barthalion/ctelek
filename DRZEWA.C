    ...
    do
   	{
		printf("Wariant: (1/2/3/4/5/6/7/8/9)");
   	    ...
   	    switch(wariant)
   		{
            case 1: //konstr z pliku input, druk i odwiedzanie drzewa BST
                {
                czyt1(&n); //n- dlugosc ciagu danych
                konstr(n,&BST); //konstr z pliku input
...
void konstr(int n, ref ** t)// BST z pliku input
{
int i,x;
    *t=NULL;
